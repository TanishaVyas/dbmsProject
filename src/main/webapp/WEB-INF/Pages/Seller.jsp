        ...
        <div style="width: 1440px; height: 829px; position: relative; background: white">
            <div style="width: 996px; left: 450px; top: 90px; position: absolute; flex-direction: column; justify-content: flex-start; align-items: flex-start; gap: 32px; display: inline-flex">
                ...
                <div style="width: 996px; height: 563px; position: relative">
                    ...
                    <div style="padding-bottom: 20px; left: 0px; top: 0px; position: absolute; background: white; box-shadow: 0px -1px 0px #EBEEF7 inset; justify-content: center; align-items: center; gap: 24px; display: inline-flex">
                        <div style="width: 328px; color: #464D61; font-size: 14px; font-family: Nunito; font-weight: 400; line-height: 20px; word-wrap: break-word"><%= product.getName() %></div>
                        <div style="width: 132px; color: #464D61; font-size: 14px; font-family: Nunito; font-weight: 400; line-height: 20px; word-wrap: break-word">[Date]</div>
                        <div style="width: 132px; color: #464D61; font-size: 14px; font-family: Nunito; font-weight: 400; line-height: 20px; word-wrap: break-word"><%= product.getPrize() %></div>
                        <div style="width: 132px; color: #464D61; font-size: 14px; font-family: Nunito; font-weight: 400; line-height: 20px; word-wrap: break-word">[Status]</div>
                        <div style="width: 164px; color: #464D61; font-size: 14px; font-family: Nunito; font-weight: 400; line-height: 20px; word-wrap: break-word">[Action]</div>
                    </div>
                    <% } %>
                </div>
            </div>
