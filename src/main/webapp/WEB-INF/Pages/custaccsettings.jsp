...
<html>
    <head>
        ...
        <%
            Trial custuser = (Trial) session.getAttribute("user");
        %>
    </head>
    <body>
                        ...
                        <div style="flex-direction: column; justify-content: flex-start; align-items: flex-start; gap: 18px; display: flex">
                            <div style="justify-content: flex-start; align-items: flex-start; gap: 18px; display: inline-flex">
                                <div style="width: 483px; flex-direction: column; justify-content: flex-start; align-items: flex-start; gap: 8px; display: inline-flex">
                                    ...
                                    <div style="width: 483px; height: 48px; position: relative; background: white; border-radius: 5px; border: 1px #EDEFF5 solid">
                                        <div id="fullname" style="left: 18px; top: 12px; position: absolute; color: #939AAD; font-size: 16px; font-family: Nunito; font-weight: 400; line-height: 24px; width: 445px; height: 24px; background: transparent; border: none; border-radius: 0; outline: none;"><%= custuser.getName() %></div>
                                    </div>
                                </div>
                                ...
                                <div style="width: 483px; flex-direction: column; justify-content: flex-start; align-items: flex-start; gap: 8px; display: inline-flex">
                                    ...
                                    <div style="width: 483px; height: 48px; position: relative; background: white; border-radius: 5px; border: 1px #EDEFF5 solid">
                                        <div id="phone" style="left: 21px; top: 7px; position: absolute; color: #939AAD; font-size: 16px; font-family: Nunito; font-weight: 400; line-height: 24px; width: 445px; height: 24px; background: transparent; border: none; border-radius: 0; outline: none;"><%= custuser.getEmail() %></div>
                                    </div>
                                </div>
                            ...
                            <div style="justify-content: flex-start; align-items: flex-start; gap: 18px; display: inline-flex">
                                <div style="width: 483px; flex-direction: column; justify-content: flex-start; align-items: flex-start; gap: 8px; display: inline-flex">
                                    ...
                                    <div style="width: 483px; height: 48px; position: relative; background: white; border-radius: 5px; border: 1px #EDEFF5 solid">
                                        <div id="email" style="left: 18px; top: 12px; position: absolute; color: #939AAD; font-size: 16px; font-family: Nunito; font-weight: 400; line-height: 24px; width: 445px; height: 24px; background: transparent; border: none; border-radius: 0; outline: none;"><%= custuser.getPhone() %></div>
                                    </div>
                                </div>
                                    <form action="/deletecustomer"  method="post" name="deleteseller" method="post">
                                <button type="submit">
